...
class MBWithPBTBTExperiment:
    ...
    def run_controller(self):
        ...
        controller = PBTwBT_Controller(
            ...
            exploration_bt=Exploration_BT(mutations,
                cs_space=cs_space,
                boundaries=boundaries,
                resample_probability=self.resample_probability),
            ready=lambda: True,
        ...
        tqdm.write("controller with PBT_BT starts!")
